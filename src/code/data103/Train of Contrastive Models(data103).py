...
if __name__ == '__main__':
    ...
    save_results(scores_to_summary(svr_scores), f"{RUN_TIME}_SVR_summary.json")
    save_results(mlp_all_metrics, f"{RUN_TIME}_MLP_all_metrics.json")
    save_results(scores_to_summary(mlp_scores), f"{RUN_TIME}_MLP_summary.json")
    save_results(gbr_all_metrics, f"{RUN_TIME}_GBR_all_metrics.json")
    save_results(scores_to_summary(gbr_scores), f"{RUN_TIME}_GBR_summary.json")
    save_results(xgb_all_metrics, f"{RUN_TIME}_XGB_all_metrics.json")
    save_results(scores_to_summary(xgb_scores), f"{RUN_TIME}_XGB_summary.json")